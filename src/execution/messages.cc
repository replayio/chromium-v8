...
Handle<JSMessageObject> MessageHandler::MakeMessageObject(
  ...
  {
    // This code gets called when handling exceptions and might call into
    // Replay's own JavaScript event/command handling code. We thus need
    // to store current exception state, and then reset it after we have
    // finished.
