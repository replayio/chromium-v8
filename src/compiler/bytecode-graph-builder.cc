...
void BytecodeGraphBuilder::VisitRecordReplayIncExecutionProgressCounter2() {
  PrepareEagerCheckpoint();

  Node* closure = GetFunctionClosure();
  const Operator* op = javascript()->CallRuntime(Runtime::kRecordReplayAssertExecutionProgress2);
